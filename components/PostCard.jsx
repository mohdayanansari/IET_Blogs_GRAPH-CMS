    ...
    <div className="p-0 pb-12 mb-8 bg-white rounded-lg shadow-lg lg:p-8">
      <div className="relative mb-6 overflow-hidden shadow-md pb-80">
        <Image
          ...
          alt={post.title}
          className="absolute object-cover w-full rounded-t-lg shadow-lg oject-top h-80 lg:rounded-lg"
          width={100}
          height={100}
          layout="fill"
        />
      ...
      <div className="items-center justify-center block w-full mb-8 text-center lg:flex">
        ...
        <div className="font-medium text-gray-700">
          ...
          <span>Posted on {moment(post.createdAt).format("MMM DD, YYYY")}</span>
        </div>
      </div>
      <p className="px-4 mb-8 text-lg font-normal text-center text-gray-700 lg:p-20">
        {post.excerpt}
      </p>
